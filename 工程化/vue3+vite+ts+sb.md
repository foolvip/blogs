...
- 初始化项目（包管理器+开发/构建工具）
- 各类开发工具配置（TS + 样式预处理器 + Lint + Git 工具 + 前端测试 + 格式化等）
- 测试辅助工具的可用性及适用性
- 功能/业务代码开发（本文不涉及）
- 校验、测试、规范化、Git 操作等
...
- [elemen-plus 官网按需引入](https://element-plus.org/zh-CN/guide/quickstart.html#%E6%8C%89%E9%9C%80%E5%AF%BC%E5%85%A5)
...
3. 在 src 的 styles 文件夹下新建 element.scss 文件
...
2. 在\.storybook 文件夹中新建：middleware.js
